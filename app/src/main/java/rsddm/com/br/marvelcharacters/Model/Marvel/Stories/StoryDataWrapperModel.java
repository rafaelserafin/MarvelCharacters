...
import rsddm.com.br.marvelcharacters.Model.Marvel.Events.EventDataContainerModel;
...
public class StoryDataWrapperModel {
    ...
    private StoryDataContainerModel data;
    private String etag;
    ...
    public StoryDataContainerModel getData() {
        return data;
    }
    ...
    public void setData(StoryDataContainerModel data) {
        this.data = data;
    }
