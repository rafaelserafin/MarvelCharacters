...
public class CharacterDataWrapperModel {
    ...
    private CharacterDataContainerModel data;
    private String etag;
    ...
    public CharacterDataContainerModel getData() {
        return data;
    }
    ...
    public void setData(CharacterDataContainerModel data) {
        this.data = data;
    }
