...
public class SeriesDataWrapperModel {
    ...
    private SeriesDataContainerModel data;
    private String etag;
    ...
    public SeriesDataContainerModel getData() {
        return data;
    }
    ...
    public void setData(SeriesDataContainerModel data) {
        this.data = data;
    }
